...
restService.post("/benefitsCalculator", function(req, res) {
    var _Household =
        req.body.queryResult &&
        req.body.queryResult.parameters &&
        req.body.queryResult.parameters.Household ?
        req.body.queryResult.parameters.Household : "";

    var _EarnedIncome =
        req.body.queryResult &&
        req.body.queryResult.parameters &&
        req.body.queryResult.parameters.EarnedIncome ?
        req.body.queryResult.parameters.EarnedIncome : "";

    var _UnEarnedIncome =
        req.body.queryResult &&
        req.body.queryResult.parameters &&
        req.body.queryResult.parameters.UnEarnedIncome ?
        req.body.queryResult.parameters._UnEarnedIncome : "";

    var _HouseholdDisability =
        req.body.queryResult &&
        req.body.queryResult.parameters &&
        req.body.queryResult.parameters.HouseholdDisability ?
        req.body.queryResult.parameters.HouseholdDisability : "";

    var _HouseholdAgedPerson =
        req.body.queryResult &&
        req.body.queryResult.parameters &&
        req.body.queryResult.parameters.HouseholdAgedPerson ?
        req.body.queryResult.parameters.HouseholdAgedPerson : "";
