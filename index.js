...
restService.post("/createIntake", function (req, res) {
  ...
  var speech = '';
  var access_token = '';
  speech = '<speak><break strength="x-strong"/> Congratulations. <break time=".5s"/> Intake has been created with Intake number <say-as interpret-as="cardinal">I202000459131</say-as></speak>';
